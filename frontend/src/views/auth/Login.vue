    ...
    <div class="flex content-center items-center justify-center h-full">
      <div class="w-full lg:w-4/12 px-4">
          ...
          <div class="flex-auto px-4 lg:px-10 py-8 pt-4">
            ...
            <form @submit.prevent="handleLogin">
              ...
              <button
                type="submit"
                :disabled="loading"
                class="bg-blueGray-800 hover:bg-blueGray-700 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none w-full ease-linear transition-all duration-150 disabled:opacity-50"
              >
            ...
            <div class="text-center mt-4">
              ...
              >
                Belum punya akun? <span class="font-bold">Daftar</span>
              </router-link>
            </div>
          </div>
        </div>
        ...
        <div class="text-center">
          <router-link
            to="/"
            class="text-blueGray-400 text-sm hover:text-blueGray-600"
          >
