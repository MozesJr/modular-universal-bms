...
const packSchema = new mongoose.Schema(
  {
    ...
    // ── Balancer / imbalance tracking ──────────────────────
    max_imbalance_mv: { type: Number, default: 100 }, // threshold alert "imbalance" (mV)
    voltage_delta_mv: { type: Number, default: 0 }, // delta terakhir (max-min antar cell), diupdate mqttService
