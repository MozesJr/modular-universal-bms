...
// Fill is pinned to the theme's accent teal (not `currentColor`) so the
// mark reads the same brand color everywhere it's placed, regardless of
// the ambient text color of whatever toolbar/button wraps it.
const Logo = (props: SvgIconProps) => {
  ...
  return (
    <SvgIcon width="56" height="56" viewBox="0 0 56 56" fill="none" {...props}>
      <rect width="56" height="56" rx="8" fill={accent} />
      <path
